...
# print(angleToVector(45))
# print(angleToVector(-45))

# print(angleToVector(90))
# print(angleToVector(-90))
...
# print(closestAxisVector((.8, .2)))
# print(closestAxisVector((-.8, .2)))
# print(closestAxisVector((-.8, -.2)))
# print(closestAxisVector((.8, .6)))
# print(closestAxisVector((1, 0)))
# print(closestAxisVector((.2, -.8)))
